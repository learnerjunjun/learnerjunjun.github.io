...
n.registerRoute(s)}function l(e){y().precache(e)}try{self["workbox:precaching:7.4.0"]&&_()}catch(e){}class u{constructor(){this.updatedURLs=[],this.notUpdatedURLs=[],this.handlerWillStart=async({request:e,state:t})=>{t&&(t.originalRequest=e)},this.cachedResponseWillBeUsed=async({event:e,state:t,cachedResponse:s})=>{if("install"===e.type&&t&&t.originalRequest&&t.originalRequest instanceof Request){const e=t.originalRequest.url
s?this.notUpdatedURLs.push(e):this.updatedURLs.push(e)}return s}}}class d{constructor({precacheController:e}){this.cacheKeyWillBeUsed=async({request:e,params:t})=>{const s=(null==t?void 0:t.cacheKey)||this.U.getCacheKeyForURL(e.url)
return s?new Request(s,{headers:e.headers}):e},this.U=e}}class f extends c.Strategy{constructor(e={}){e.cacheName=t.cacheNames.getPrecacheName(e.cacheName),super(e),this.K=!1!==e.fallbackToNetwork,this.plugins.push(f.copyRedirectedCacheableResponsesPlugin)}async _handle(e,t){return await t.cacheMatch(e)||(t.event&&"install"===t.event.type?await this.T(e,t):await this.I(e,t))}async I(e,t){let r
const a=t.params||{}
if(!this.K)throw new s.WorkboxError("missing-precache-entry",{cacheName:this.cacheName,url:e.url})
{const s=a.integrity,c=e.integrity,n=!c||c===s
r=await t.fetch(new Request(e,{integrity:"no-cors"!==e.mode?c||s:void 0})),s&&n&&"no-cors"!==e.mode&&(this.P(),await t.cachePut(e,r.clone()))}return r}async T(e,t){this.P()
...
class p{constructor({cacheName:e,plugins:s=[],fallbackToNetwork:r=!0}={}){this.F=new Map,this.B=new Map,this.S=new Map,this.u=new f({cacheName:t.cacheNames.getPrecacheName(e),plugins:[...s,new d({precacheController:this})],fallbackToNetwork:r}),this.install=this.install.bind(this),this.activate=this.activate.bind(this)}get strategy(){return this.u}precache(e){this.addToCacheList(e),this.$||(self.addEventListener("install",this.install),self.addEventListener("activate",this.activate),this.$=!0)}addToCacheList(e){const t=[]
...
if(this.F.has(a)&&this.F.get(a)!==e)throw new s.WorkboxError("add-to-cache-list-conflicting-entries",{firstEntry:this.F.get(a),secondEntry:e})
if("string"!=typeof r&&r.integrity){if(this.S.has(e)&&this.S.get(e)!==r.integrity)throw new s.WorkboxError("add-to-cache-list-conflicting-integrities",{url:a})
this.S.set(e,r.integrity)}this.F.set(a,e),this.B.set(a,c),t.length>0&&t.join(", ")}}install(e){return r.waitUntil(e,(async()=>{const t=new u
this.strategy.plugins.push(t)
for(const[t,s]of this.F){const r=this.S.get(s),a=this.B.get(t),c=new Request(t,{integrity:r,cache:a,credentials:"same-origin"})
await Promise.all(this.strategy.handleAll({params:{cacheKey:s},request:c,event:e}))}const{updatedURLs:s,notUpdatedURLs:r}=t
return{updatedURLs:s,notUpdatedURLs:r}}))}activate(e){return r.waitUntil(e,(async()=>{const e=await self.caches.open(this.strategy.cacheName),t=await e.keys(),s=new Set(this.F.values()),r=[]
for(const a of t)s.has(a.url)||(await e.delete(a),r.push(a.url))
return{deletedURLs:r}}))}getURLsToCacheKeys(){return this.F}getCachedURLs(){return[...this.F.keys()]}getCacheKeyForURL(e){const t=new URL(e,location.href)
return this.F.get(t.href)}getIntegrityForCacheKey(e){return this.S.get(e)}async matchPrecache(e){const t=e instanceof Request?e.url:e,s=this.getCacheKeyForURL(t)
